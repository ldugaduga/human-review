	...
	protected function render() {
		...
		<section class="bg-surface">
			<div class="max-w-[1280px] mx-auto px-6 lg:px-10 py-16 lg:py-20 grid lg:grid-cols-2 gap-12 items-center">
				<div class="flex flex-col items-start gap-8 w-full max-w-[1024px]">
					<span class="box-border inline-flex flex-row justify-center items-start w-[138px] h-[30px] px-4 py-1.5 bg-gradient-to-b from-white to-[#F1F1F1] border border-[#EEEEEE] rounded-full text-[11px] font-semibold tracking-[0.12em] text-ink/60 uppercase">
					...
					<p class="text-ink/60 text-[17px] leading-relaxed max-w-md">
						<?php echo esc_html( $settings['subcopy'] ); ?>
					</p>
					<a href="<?php echo esc_url( $settings['button_link']['url'] ); ?>" class="inline-flex items-center gap-2.5 bg-orange hover:bg-orange-600 transition text-white font-semibold text-[15px] pl-6 pr-2 py-2 rounded-full">
